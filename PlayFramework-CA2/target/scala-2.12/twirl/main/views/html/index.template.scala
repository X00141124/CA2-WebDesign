  ...
  <body>
	...
	<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active">
					<a href=""""),_display_(/*97.16*/routes/*97.22*/.LoginController.login()),format.raw/*97.46*/(""""><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
	...
	<main>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
			...
			<div class="item active">
			  <img src="/assets/images/spain.jpg" alt="Spain" style="width:100%;">
			</div>

			<div class="item">
			  <img src="/assets/images/paris.jpg" alt="Paris" style="width:100%;">
			</div>
			
			<div class="item">
			  <img src="/assets/images/london.jpg" alt="London" style="width:100%;">
			</div>
			
			<div class="item">
			  <img src="/assets/images/bangkok.jpg" alt="Bangkok" style="width:100%;">
			</div>
			
			<div class="item">
			  <img src="/assets/images/agra.jpg" alt="Agra" style="width:100%;">
			</div>

			<div class="item">
			  <img src="/assets/images/honshu.jpg" alt="Honshu" style="width:100%;">
			</div>
			
			<div class="item">
			  <img src="/assets/images/etihad2.jpg" alt="Abu Dhabi" style="width:100%;">
			</div>
		...
		<div id="textContent" class="col-sm-5">
			<h3>Plan Your Perfect Holiday</h3>
			<p>Sunshine Travel allows you to make the perfect holiday.<br><br>
			Choose your ideal hotel, flights, transfer, plus any other arrangements you need and create something truly special.
			<br> At Sunshine Travel, the perfect holiday is <b>yours for just one click.</b>
			<br><br> Don't forget to check out our <a href="/deals">deals</a> section!</p>

			<h3>A Holiday Type for you</h3>
			<p>At Sunshine Travel, it's about your individual preferences, your personal holiday tastes - and how we can help your search.
			Whether you're looking for <a href="/hotels">hotel</a>, <a href="/flight">flights</a>, or <a href="/deals">package deals</a>, 
			with Sunshine Travel you can find the holiday you want, at the hotel you want, at the time you want. And all price you'd love.</p>
		</div>
		<div id="imgContent" class="col-sm-6">
		<div class="textContent">
		<img src="/assets/images/planning.jpg" alt="Planning" style="width:100%;">
		</div>
		</div>
		<div class="col-sm-1"></div>
		</div>
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: C:/Users/brand/Downloads/WebCA2/app/views/index.scala.html
                  HASH: 185b50b369ca2e37316b5b4de5e99b6be07106e4
                  MATRIX: 1030->0|4674->3617|4689->3623|4734->3647
                  LINES: 33->1|129->97|129->97|129->97
                  -- GENERATED --
              */
